...
const DashboardSidebar = () => {
  ...
  return (
    <aside className="custom-scrollbar bg-white border-r h-screen top-0 left-0 sticky overflow-y-auto boxShadow rounded-md transition-all duration-300 ease w-[250px]">
