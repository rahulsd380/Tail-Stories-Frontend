    ...
    return (
        <div className="font-Lato">
           ...
           <div className="bg-primary-gradient px-5 py-4 rounded-t-lg text-white flex items-center justify-between">
                ...
                <RxCross2 onClick={() => setOpenPaymentModal(false)} className="text-2xl cursor-pointer"/>
           </div>
...
<div className="flex flex-col gap-1 w-full">
            ...
            <p className="text-sm text-[#364F53] dark:text-[#D9D9D9]/50 text-center">
                Don't want to pay now?<Link onClick={() => setOpenPaymentModal(false)} href={"/"} className="font-semibold text-primary-30"> {" "} Cancel</Link>
              </p>
          </form>
        </div>
    );
